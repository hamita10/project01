        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                             <form method="POST" action="{{route('Admin.thoughts.store')}}" enctype="multipart/form-data">
                                @csrf
                                <tr >
                                    <div class="row" >
                                        <div class="col-3">
                                            <div class="mx-auto" style="width: 140px;">
                                                <div class="d-flex justify-content-left align-items-left rounded"
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="col-lg-4">
                                        <label for="formrow-student_name-input" class="form-label">Student Name</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" name="description" placeholder=" Enter Your Description"></textarea>
                                            </div>
                                            <span class="text-danger">
                                                @error('description')
                                                   {{$message}} 
