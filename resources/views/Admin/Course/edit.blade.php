        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Course Edit Layouts</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <tr style="text-align: center">
                                    ...
                                    <div class="col-12 ">
                                        <div class="mx-auto" style="width: 140px;">
                                            <div class="d-flex justify-content-center align-items-center rounded"
                                                ...
                                                @else
                                                    <img src="{{ asset('/adminassets/Uploads/course') . '/' . $course->image }}"
                                                        id="wizardPicturePreview" alt=""
                                                        class="img-thumbnail"
                                                        style="  width: 100%;height: 100%;">
                                                @endif
                                ...
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" value="{{$course->code_number}}" name="code_number" id="formrow-code_number-input" placeholder="Enter Your code number">
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{$course->name}}" id="formrow-name-input" placeholder="Enter Your name">
                                        <span class="text-danger">
                                            @error('name')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name="description" placeholder=" Enter Your Description">{{$course->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
