            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Subject Create Layouts</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                ...
                                <tr style="text-align: center">
                                    ...
                                    <div class="row">
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="leassons" id="formrow-name-input" placeholder="Enter Your leassons">
                                            <span class="text-danger">
                                                @error('leassons')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="price" id="formrow-name-input" placeholder="Enter Your price">
                                            <span class="text-danger">
                                                @error('price')
                                                    {{ $message }}
                                                @enderror
