...
<!-- form wizard init -->
 ...
 <script src="{{asset('AdminAssets/libs/bootstrap-timepicker/js/bootstrap-timepicker.min.js')}}"></script>
 ...
 <script src="{{asset('AdminAssets/libs/%40chenfengyuan/datepicker/datepicker.min.js')}}"></script>
